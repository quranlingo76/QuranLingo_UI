    ...
    <div className="flex items-center gap-3 select-none">
      <div className={`relative flex items-center justify-center ${className}`}>
         ...
         <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-sm">
            {/* Outer Bubble Shape */}
            <path d="M50 5C25.1472 5 5 22.9086 5 45C5 59.5 13.5 72.3 26 79.5V95L42 84.5C44.6 84.8 47.3 85 50 85C74.8528 85 95 67.0914 95 45C95 22.9086 74.8528 5 50 5Z" fill="var(--color-primary)"/>
            {/* Inner Glare/Detail */}
      ...
      {withText && (
        <div className="flex flex-col justify-center">
            <h1 className="font-black text-[var(--color-primary)] tracking-tighter text-2xl leading-none">QURAN<span className="text-[var(--color-secondary)]">LINGO</span></h1>
        </div>
      )}
    </div>
  );
